        ...
        <div class="card-body">
          <div class="table-responsive text-nowrap">
            <table class="table table-bordered" id="registrationTable">
              ...
              <?php
                while ($row = mysqli_fetch_array($notpayed)) {
              ...
              ?>
                ...
                ?></td>
                  ...
                  if ($row['payment_status'] == '0')
                    echo 'Not Paid';
                  elseif ($row['payment_status'] == '1' and $row['status'] == '0')
                    echo 'Payment Confirmed';
                  elseif ($row['payment_status'] == '1' and $row['status'] == '1' and $tresponces == 0)
                    echo 'Go and Play';
                  elseif ($row['payment_status'] == '1' and $row['status'] == '1' and $tresponces < 15)
                    echo 'Semi Played';
                  elseif ($row['payment_status'] == '1' and $row['status'] == '1' and $tresponces == 15)
                    echo 'Game Completed';
                  elseif ($row['payment_status'] > 1 and $row['status'] == '1' and $tresponces == '0')
                    echo 'Choose to Replay';
                  elseif ($row['payment_status'] > 1 and $row['status'] == '1' and $tresponces < '15')
                    echo 'Semi Replay';
                  elseif ($row['payment_status'] > 1 and $row['status'] == '1' and $tresponces == '15')
                    echo 'Replayed';
